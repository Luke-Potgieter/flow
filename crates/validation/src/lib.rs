...
/// connector validation RPCs are dispatched. Requests will always be Validate variants.
/// We do not pass a Validate directly to reserve the possibility of including additional
/// fields such as `internal`, but do not do so today.
